...
/* ==========================
    FETCH TRAININGS WITH REVIEW STATISTICS
   ========================== */
...
if (!empty($searchQuery)) {
    $query .= " AND (c.courseName LIKE ? OR c.courseLocation LIKE ?)";
}

// UPDATED: Adjusted Group By to use new date columns
$query .= " GROUP BY c.courseID, c.courseName, c.startDate, c.endDate, c.courseLocation, c.maxParticipant
...
<head>
    <meta charset="UTF-8">
    <title>Select Training Review</title>
...
<div class="main-content">
    <h2><i class="fas fa-graduation-cap"></i> Manage Training Reviews</h2>

    <form method="get" action="" class="search-bar">
        <input type="text" name="search" placeholder="Search training name or location..." value="<?= htmlspecialchars($searchQuery) ?>">
        <button type="submit"><i class="fas fa-search"></i> Search</button>
        <a href="select_training_review.php" class="btn-clear"><i class="fas fa-undo"></i> Clear</a>
    </form>
    ...
    <div class="event-grid">
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): 
                ...
                // UPDATED: Date Logic for Start and End Date
                $start = $row['startDate'];
                $end = $row['endDate'];
                ...
                <div class="card-content">
                    ...
                    <div class="card-metrics">
                        ...
                        <div class="metric-item">
                            ...
                            Location: <?= htmlspecialchars($row['courseLocation']) ?>
                        </div>
                        <div class="metric-item">
                    ...
                    <div class="card-actions">
                        ...
                        <a href="review_training.php?courseID=<?= $row['courseID'] ?>" class="btn-analyze">
        ...
        <?php else: ?>
            <div style="grid-column: 1/-1; text-align: center; background: white; padding: 40px; border-radius: 8px; box-shadow: var(--box-shadow);">
                <p style="color: #777;"><i class="fas fa-info-circle"></i> No training courses found matching your search.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
